...
const DEFAULT_PERMISSIONS: Record<AppRole, Permission[]> = {
  ...
  manager: [
    'jobs.view', 'jobs.create', 'jobs.edit', 'jobs.read', 'jobs.update',
    'production.view', 'production.register', 'production.edit',
    'operators.view', 'operators.create', 'operators.edit', 'operators.read',
    'reports.view', 'reports.export', 'reports.read',
    'settings.view', 'settings.read',
    'security.view', 'machines.read', 'machines.update',
    'users.read',
  ...
  operator: [
    'jobs.view', 'jobs.read', 'jobs.update',
    'production.view', 'production.register',
    'operators.view', 'operators.read',
    'machines.read',
