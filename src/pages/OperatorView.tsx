      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 animate-fade-in-up">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Button variant="outline" size="sm" onClick={() => navigate('/shift-handover')} className="gap-2 shadow-sm hover:shadow-md transition-all active:scale-95 border-amber-500/30"><ArrowRightLeft className="h-4 w-4 text-warning" /><span className="hidden sm:inline">Passagem de Turno</span></Button>
            <Button variant="outline" size="sm" onClick={() => navigate('/oee')} className="gap-2 shadow-sm hover:shadow-md transition-all active:scale-95 border-emerald-500/30"><Gauge className="h-4 w-4 text-success" /><span className="hidden sm:inline">Meu OEE</span></Button>
          </div>
        </div>
