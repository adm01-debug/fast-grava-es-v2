    ...
    variants: {
      variant: {
        ...
        gradient: [
          ...
          "shadow-[0_4px_20px_-5px_hsl(var(--primary)/0.4)]",
          "hover:shadow-[0_8px_30px_-5px_hsl(var(--primary)/0.6)]",
          "hover:translate-y-[-2px]",
          "active:translate-y-0",
        ],
        "gradient-secondary": [
          "gradient-secondary text-white border-0",
          "shadow-[0_4px_20px_-5px_hsl(210_100%_60%/0.4)]",
          "hover:shadow-[0_8px_30px_-5px_hsl(210_100%_60%/0.6)]",
          "hover:translate-y-[-2px]",
        ],
        "gradient-success": [
          "gradient-success text-white border-0",
          "shadow-[0_4px_20px_-5px_hsl(142_70%_50%/0.4)]",
          "hover:shadow-[0_8px_30px_-5px_hsl(142_70%_50%/0.6)]",
          "hover:translate-y-[-2px]",
        ],
        glow: [
          "bg-primary text-primary-foreground",
          "shadow-[0_0_30px_-5px_hsl(var(--primary)/0.5)]",
          "hover:shadow-[0_0_50px_-5px_hsl(var(--primary)/0.7)]",
          "hover:translate-y-[-2px]",
          "pulse-glow",
        ],
        glass: [
          "bg-white/10 text-foreground border border-white/10 backdrop-blur-xl",
          "hover:bg-white/20 hover:border-white/20",
          "dark:text-white dark:hover:shadow-[0_0_20px_-8px_hsl(0_0%_100%/0.2)]",
        ],
      },
      size: {
