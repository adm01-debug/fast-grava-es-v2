    ...
    <div className="space-y-0.5">
      <Button
        ...
        className={cn(
          ...
          "hover:bg-sidebar-accent/50 hover:text-sidebar-foreground hover:pl-4 transition-all duration-300 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1",
