import {
  ...
  Binary, Fingerprint, Layers, Cpu as Microchip
} from 'lucide-react';
import { NavGroup } from './NavGroupComponent';
import { NavItem } from './NavButton';

export const navGroups: NavGroup[] = [
  { id: 'home', icon: Binary, label: 'Control Center', items: [{ icon: Home, label: 'Performance Pulse', href: '/' }], defaultOpen: true },
  ...
  { id: 'analytics', icon: Layers, label: 'Strategic Insights', items: [
  ...
  { id: 'operations', icon: Microchip, label: 'Performance Units', items: [
  ...
  { id: 'team', icon: Fingerprint, label: 'Human Capital', items: [
