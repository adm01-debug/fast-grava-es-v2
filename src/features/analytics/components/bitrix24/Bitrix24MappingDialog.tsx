    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent>
        ...
        <div className="space-y-4 py-4">
          ...
          {newMapping.mapping_type === 'field' && (<div className="space-y-2"><Label>Prioridade</Label><Input type="number" value={newMapping.priority} onChange={(e) => setNewMapping({...newMapping, priority: parseInt(e.target.value, 10) || 0})} min={0} /><p className="text-xs text-muted-foreground">Campos com menor prioridade são verificados primeiro</p></div>)}
        </div>
